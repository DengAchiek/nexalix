...
def global_site_context(_request):
    ...
    if footer_context is None:
        ...
        configured_socials = [
            ("LinkedIn", "fab fa-linkedin-in", getattr(settings, "FOOTER_LINKEDIN_URL", "").strip() or "#"),
            ("Instagram", "fab fa-instagram", getattr(settings, "FOOTER_INSTAGRAM_URL", "").strip() or "#"),
            ("Facebook", "fab fa-facebook-f", getattr(settings, "FOOTER_FACEBOOK_URL", "").strip() or "#"),
            ("X", "fab fa-x-twitter", getattr(settings, "FOOTER_X_URL", "").strip() or "#"),
            ("GitHub", "fab fa-github", getattr(settings, "FOOTER_GITHUB_URL", "").strip() or "#"),
            ("WhatsApp", "fab fa-whatsapp", footer_whatsapp_url or "#"),
        ]
        footer_social_links = [
